      ...
      <div className="bg-cover bg-center h-full"
        ...
        <div className='pt-24 sm:pr-20 pl-44 sm:pl-80 '>
          <p className='text-slate-400 py-2 pl-4 rounded text-2xl  bg-blue-950 flex justify-normal'>
            ...
            <span className='pl-11'>Submit Grade</span>
          </p>
        </div>
        ...
        <div className=' sm:pr-20 pl-44 sm:pl-80'>
          <div className='pb-8  sm:text-2xl font-serif'>
            <p className='bg-grayish-156 py-5 sm:rounded pl-2 '> <span className='pr-4'>1.</span> Bereket Fanse  <span className=' px-4 sm:px-20'>Bereketfanose@gmail.com </span>

            </p>
          </div>
          <div className='pb-8  sm:text-2xl font-serif'>
            <p className='bg-grayish-156 py-5 sm:rounded pl-2 '> <span className='pr-4'>2.</span> Bereket Fanse  <span className=' px-4 sm:px-20'>Bereketfanose@gmail.com </span>

            </p>
          </div>
          <div className='pb-8  sm:text-2xl font-serif'>
            <p className='bg-grayish-156 py-5 sm:rounded pl-2 '> <span className='pr-4'>3.</span> Bereket Fanse  <span className=' px-4 sm:px-20'>Bereketfanose@gmail.com </span>
