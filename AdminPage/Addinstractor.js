...
function Addinstractor() {
  ...
  const handleSalaryChange = (event) => {
    ...
    if (parsedSalary >= 4000 && parsedSalary <= 50000) {
      setIsValid(true);
      ...
      <div className='pl-44 sm:pl-72'>
        <form onSubmit={handleSubmit}
          ...
          <div className='form-group flex justify-normal pl-36 flex-col sm:flex-row '>
            ...
            <label className='sm:text-xl font-semibold  text-gray-700 '>Sex</label><br/>
              ...
              <label className='sm:text-xl font-semibold  text-gray-700 '>Salary </label><br />
                ...
                />
                {!isValid && (
                  <p className="text-red-500">Salary must be between 4000 and 50000</p>
                )}
                <br />
              </div>
              <div className='sm:pb-4'>
              <label className='sm:text-xl font-semibold  text-gray-700 '>Experience</label><br />
                <input className='border-spacing-3 border border-gray-800 py-2 px-3'
                  type='number'
                  min="0"
                  name='Experience'
